  ...
  async fetch(request, env, ctx) {
    ...
    if (path === '/api/registrations' && method === 'POST') {
      ...
      try {
        ...
        return json({ success: false, message: 'Submission failed: ' + e.message, debug: e.toString().substring(0, 500) }, 500);
      }
    }
...
--70d1df3bcc1b981e033a659c9f25acd9e6c0b7e0e950782d49f816b21678--
